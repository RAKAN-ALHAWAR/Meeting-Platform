...
class TranslationX extends Translations {
  ...
  static String getCurrentNameLanguage() {
    ...
    return languages.firstWhere((lang) => x == lang['code'])['name']??"not found";
  }

  /// Fetch the locale of the current language
  static Locale get getLocale => Locale(Get.locale?.languageCode??LocalDataX.language);

  /// Fetch the code of the current language
  static String get getLanguageCode => Get.locale?.languageCode??LocalDataX.language;
