...
class LocalDataX<T>{
  ...
  static String get route => get(LocalKeyX.route,defaultData: LocalDefaultDataX.route);
  static bool get themeIsDark => get(LocalKeyX.themeIsDark,defaultData: LocalDefaultDataX.themeIsDark);
  static String get language => get(LocalKeyX.language,defaultData: LocalDefaultDataX.language);
