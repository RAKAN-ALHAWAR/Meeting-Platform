...
class ConsoleUtilX {
  static void log(String message, {ConsoleColorStatus color = ConsoleColorStatus.white}) {
  ...
  static void _printMessage(String message) {
    ...
    pattern.allMatches(message).forEach((match) => print(match.group(0))); // On other platforms, print normally
  }
